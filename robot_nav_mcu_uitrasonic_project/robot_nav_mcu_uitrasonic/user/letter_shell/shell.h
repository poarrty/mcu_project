...
#define SHELL_EXPORT_CMD(_attr, _name, _func, _desc)                   \
    ...
    const ShellCommand shellCommand##_name SECTION("shellCommand") = { \
        .attr.value = _attr,                                           \
...
#define SHELL_EXPORT_VAR(_attr, _name, _value, _desc)              \
    const char shellCmd##_name[] = #_name;                         \
    const char shellDesc##_name[] = #_desc;                        \
    const ShellCommand shellVar##_name SECTION("shellCommand") = { \
        .attr.value = _attr,                                       \
...
#define SHELL_EXPORT_USER(_attr, _name, _password, _desc)           \
    ...
    const char shellDesc##_name[] = #_desc;                         \
    const ShellCommand shellUser##_name SECTION("shellCommand") = { \
...
#define SHELL_EXPORT_KEY(_attr, _value, _func, _desc)               \
    ...
    const ShellCommand shellKey##_value SECTION("shellCommand") = { \
...
#define SHELL_CMD_ITEM(_attr, _name, _func, _desc)                      \
    {                                                                   \
        .attr.value = _attr, .data.cmd.name = #_name,                   \
        .data.cmd.function = (int (*)()) _func, .data.cmd.desc = #_desc \
    }
...
#define SHELL_VAR_ITEM(_attr, _name, _value, _desc)                \
    {                                                              \
        .attr.value = _attr, .data.var.name = #_name,              \
        .data.var.value = (void *) _value, .data.var.desc = #_desc \
    }
...
#define SHELL_USER_ITEM(_attr, _name, _password, _desc)             \
    {                                                               \
        .attr.value = _attr | SHELL_CMD_TYPE(SHELL_TYPE_USER),      \
        .data.user.name = #_name, .data.user.password = #_password, \
