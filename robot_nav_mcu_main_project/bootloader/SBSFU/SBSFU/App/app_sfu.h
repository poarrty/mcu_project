...
/**
  ...
  */
//#define SFU_STATUS_LED (LED_GREEN)            /*!< LED to be used to provide the SB_SFU status to the end-user */ /* @suliakng modify */
...
//#define SFU_TAMPER_PROTECT_ENABLE   /* @sulikang modify */
