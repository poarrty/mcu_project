...
struct fal_flash_dev nor_flash0 = {.name       = FAL_USING_NOR_FLASH_DEV_NAME,
                                   .addr       = 0,
                                   .len        = 16 * 1024 * 1024,
                                   .blk_size   = 4096,
...
static int init(void) {
    ...
    //     sfud_dev =
    //     rt_sfud_flash_find_by_dev_name(FAL_USING_NOR_FLASH_DEV_NAME);
    // #else
    //     /* bare metal platform */
    ...
    sfud_dev = sfud_get_device(SFUD_XXXX_DEVICE_INDEX);
