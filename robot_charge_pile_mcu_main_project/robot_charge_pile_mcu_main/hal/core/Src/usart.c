...
void HAL_IRDA_MspInit(IRDA_HandleTypeDef *irdaHandle) {
    ...
    if (irdaHandle->Instance == UART4) {
        ...
        PC11     ------> UART4_RX
        */
        GPIO_InitStruct.Pin = IRDA_TX_Pin;
        GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
        GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
        HAL_GPIO_Init(IRDA_TX_GPIO_Port, &GPIO_InitStruct);
        ...
        __HAL_LINKDMA(irdaHandle, hdmarx, hdma_uart4_rx);
        ...
        __HAL_LINKDMA(irdaHandle, hdmatx, hdma_uart4_tx);
...
void HAL_IRDA_MspDeInit(IRDA_HandleTypeDef *irdaHandle) {
    if (irdaHandle->Instance == UART4) {
        ...
        PC11     ------> UART4_RX
        */
        HAL_GPIO_DeInit(GPIOC, IRDA_TX_Pin | IRDA_RX_Pin);

        /* UART4 DMA DeInit */
        HAL_DMA_DeInit(irdaHandle->hdmarx);
