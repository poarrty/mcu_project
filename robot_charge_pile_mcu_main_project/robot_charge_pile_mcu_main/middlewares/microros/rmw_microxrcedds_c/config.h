...
#if defined(RMW_UXRCE_STREAM_HISTORY_INPUT) && \
    defined(RMW_UXRCE_STREAM_HISTORY_OUTPUT)
#undef RMW_UXRCE_STREAM_HISTORY_INPUT
#undef RMW_UXRCE_STREAM_HISTORY_OUTPUT
...
#define RMW_UXRCE_MAX_INPUT_BUFFER_SIZE \
    (RMW_UXRCE_MAX_TRANSPORT_MTU * RMW_UXRCE_STREAM_HISTORY_INPUT)
#define RMW_UXRCE_MAX_OUTPUT_BUFFER_SIZE \
    (RMW_UXRCE_MAX_TRANSPORT_MTU * RMW_UXRCE_STREAM_HISTORY_OUTPUT)
...
#define RMW_UXRCE_MAX_TOPICS_INTERNAL \
