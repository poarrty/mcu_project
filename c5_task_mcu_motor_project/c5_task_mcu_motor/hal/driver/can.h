...
#define RT_CAN_FILTER_STD_INIT(id, ind, args)          RT_CAN_FILTER_ITEM_INIT(id, 0, 0, 0, 0xFFFFFFFF, ind, args)
#define RT_CAN_FILTER_EXT_INIT(id, ind, args)          RT_CAN_FILTER_ITEM_INIT(id, 1, 0, 0, 0xFFFFFFFF, ind, args)
#define RT_CAN_STD_RMT_FILTER_INIT(id, ind, args)      RT_CAN_FILTER_ITEM_INIT(id, 0, 1, 0, 0xFFFFFFFF, ind, args)
#define RT_CAN_EXT_RMT_FILTER_INIT(id, ind, args)      RT_CAN_FILTER_ITEM_INIT(id, 1, 1, 0, 0xFFFFFFFF, ind, args)
#define RT_CAN_STD_RMT_DATA_FILTER_INIT(id, ind, args) RT_CAN_FILTER_ITEM_INIT(id, 0, 0, 1, 0xFFFFFFFF, ind, args)
#define RT_CAN_EXT_RMT_DATA_FILTER_INIT(id, ind, args) RT_CAN_FILTER_ITEM_INIT(id, 1, 0, 1, 0xFFFFFFFF, ind, args)
#else

#define RT_CAN_FILTER_ITEM_INIT(id, ide, rtr, mode, mask) \
    { (id), (ide), (rtr), (mode), (mask), -1, }
#define RT_CAN_FILTER_STD_INIT(id)          RT_CAN_FILTER_ITEM_INIT(id, 0, 0, 0, 0xFFFFFFFF)
#define RT_CAN_FILTER_EXT_INIT(id)          RT_CAN_FILTER_ITEM_INIT(id, 1, 0, 0, 0xFFFFFFFF)
#define RT_CAN_STD_RMT_FILTER_INIT(id)      RT_CAN_FILTER_ITEM_INIT(id, 0, 1, 0, 0xFFFFFFFF)
#define RT_CAN_EXT_RMT_FILTER_INIT(id)      RT_CAN_FILTER_ITEM_INIT(id, 1, 1, 0, 0xFFFFFFFF)
#define RT_CAN_STD_RMT_DATA_FILTER_INIT(id) RT_CAN_FILTER_ITEM_INIT(id, 0, 0, 1, 0xFFFFFFFF)
#define RT_CAN_EXT_RMT_DATA_FILTER_INIT(id) RT_CAN_FILTER_ITEM_INIT(id, 1, 0, 1, 0xFFFFFFFF)
#endif
