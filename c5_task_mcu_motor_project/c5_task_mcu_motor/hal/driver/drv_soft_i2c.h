...
#define I2C2_BUS_CONFIG \
    { .scl = BSP_I2C2_SCL_PIN, .sda = BSP_I2C2_SDA_PIN, .bus_name = "i2c2", }
#endif

#ifdef BSP_USING_I2C3
#define I2C3_BUS_CONFIG \
    { .scl = BSP_I2C3_SCL_PIN, .sda = BSP_I2C3_SDA_PIN, .bus_name = "i2c3", }
#endif

#ifdef BSP_USING_I2C4
#define I2C4_BUS_CONFIG \
    { .scl = BSP_I2C4_SCL_PIN, .sda = BSP_I2C4_SDA_PIN, .bus_name = "i2c4", }
#endif
