...
/**
  ...
  * @retval None
  */
static void SetSysClockTo72(void) //内部时钟64M
{
  __IO uint32_t StartUpCounter = 0, HSEStatus=0, HSIStatus=0; // HSEStatus
...
/*
  ...
  //RCC->CR |= ((uint32_t)RCC_CR_HSEON);  //使能外部时钟 
*/
	 ...
	 //if (HSIStatus == (uint32_t)0x01)
  {
	...
	//	 RCC->CFGR |= (uint32_t)(RCC_CFGR_PLLSRC_HSI_Div2 | RCC_CFGR_PLLMULL16);//将内部时钟2分频后作为PLL时钟源,倍频系数为16,即系统时钟为64M
#endif /* STM32F10X_CL */
