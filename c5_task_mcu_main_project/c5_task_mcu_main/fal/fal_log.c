 ...
 * 私有宏定义
 ******************************************************************/
#define ELOG_LVL_PRINT ELOG_LVL_WARN
/*****************************************************************
 * 私有结构体/共用体/枚举定义
 ******************************************************************/
...
int fal_log_init(void) {
    ...
    elog_set_filter_tag_lvl("fal_workstation", ELOG_LVL_PRINT);
    elog_set_filter_tag_lvl("clean_manage", ELOG_LVL_PRINT);
    elog_set_filter_tag_lvl("pal_uros", ELOG_LVL_PRINT);
    elog_set_filter_tag_lvl("fal_ota", ELOG_LVL_PRINT);
    elog_set_filter_tag_lvl("fal_key", ELOG_LVL_PRINT);
    elog_set_filter_tag_lvl("button", ELOG_LVL_PRINT);
    elog_set_filter_tag_lvl("app_led", ELOG_LVL_PRINT);
    elog_set_filter_tag_lvl("clean_ctrl", ELOG_LVL_PRINT);
    elog_set_filter_tag_lvl("detection", ELOG_LVL_PRINT);
